// this is raw logic of node.js without using expressjs or any other supporting libraries which hids this raw logic behind the scenes
const http = require('http'); // doing https requests
